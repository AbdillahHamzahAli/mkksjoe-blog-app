...
@section('title', __('categories.title.create'))
@section('breadcrumbs', Breadcrumbs::render('add_categories'))
            ...
            <form action="{{ route('categories.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <button type="submit" class="btn btn-primary">{{ __('categories.button.save.value') }}</button>
                    </div>
                </div>
