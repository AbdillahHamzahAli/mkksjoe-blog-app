...
@section('title', __('newspost.title.edit'))
@section('breadcrumbs', Breadcrumbs::render('edit_news_title', $newspost))

@section('content')

    <form action="{{ route('newspost.update', ['newspost' => $newspost]) }}" method="POST" class="row">
        @csrf
        @method('PUT')
        <div class="card">
            <div class="card-body">
                <div class="pt-4">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input value="{{ old('title', $newspost->title) }}" type="text" name="title"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input value="{{ old('slug', $newspost->slug) }}" type="text" name="slug"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input value="{{ old('thumbnail', asset($newspost->thumbnail)) }}"
                                    id="input_newspost_thumbnail" name="thumbnail" type="text"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" style="height: 100px"
                                placeholder="{{ __('newspost.form_control.textarea.description.placeholder') }}">{{ old('description', $newspost->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <textarea id="input_newspost_content" name="content"
                        ...
                        class="form-control @error('content') is-invalid @enderror" rows="20">{{ old('content', $newspost->content) }}</textarea>
                    @error('content')
                        <span class="invalid-feedback" role="alert">
                            {{ $message }}
                        </span>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select id="select_category_parent" name="category[]"
                                ...
                                @if (old('category', $newspost->categories))
                                    @foreach (old('category', $newspost->categories) as $item)
                        ...
                        <div class="col-sm-10">
                            <select id="select_newspost_status" class="form-select @error('status') is-invalid @enderror"
                                ...
                                @foreach ($statuses as $key => $value)
                                    <option value="{{ $key }}"
                                        {{ old('status', $newspost->status) == $key ? 'selected' : null }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
